...
<head>
	...
	<title>Sispak_Kelapa_Sawit</title>
	...
	<footer class="footer bg-primary">
		<div class="container">
			<p>
				...
				Teknik Informatika, Fakultas Teknik dan Ilmu Komputer, Universitas Muhammadiyah Pontianak
				<em class="pull-right">SISPAK KELAPA SAWIT</em>
			</p>
		</div>
	</footer>
</body>
